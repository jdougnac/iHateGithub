...
mutation_dict = {
    ...
    '32': ['Crown of Flesh', 'You develop fleshy protrusions around your head. No further effect.', 'TOC', '36'],
    ...
    '85': ['Long Legs', 'Your legs become unnaturally long. +1 Mov.', 'TOC', '42'],
    '86': ['Long Neck', 'Your neck becomes unnaturally long. Critical hits to the head are at +2.', 'TOC', '43'],
    '87': ['Long Nose', 'Your nose becomes unnaturally long. Gain the Follow Trail skill. +10 to smell-related'
    ...
    '127': ['Scaly Skin', 'A mesh of fine scales sprouts all over your body, granting 1 Armour Point to all locations.',
            'TOC', '49'],
    '128': ['Scorpion Tail', 'A sinister-looking tail sprouts from your back. You can attack with it at SB damage. If you'
    ...
    '163': ['Vestigial/Parasitic Twin', " You become two"
