...
def pick_ring():
    ...
    if object_id == '1':        
        ...
        if ring[0][0:11] == 'Rune Amulet':
        
#            name = 'Rune Ring' + ring[0][11:]#name = 'Ring' + ring[1][11:]
            name = 'Rune Ring' + ring[0][11:]#name = 'Ring' + ring[1][11:]
            description = 'This Ring has one or more runes inscribed. For those with a *, check the Rune document.'
        else:
            name = 'Ring' + ring[0][6:]#name = 'Ring' + ring[1][6:]
            description = 'This ring works exactly as the Amulet of the same name.'
