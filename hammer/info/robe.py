...
robe_dict = {
    '1': ['Robe of Disguise', 'The wearer can cast Assume Illusionary Appearance and Cloak Activity once per day. If'
                              ' Greater it can also cast Clone Image once per day.', 'AN', '45'],
