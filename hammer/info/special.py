...
special_dict = {
    ...
    '35': ['The Amulet of Say-K’thar ',
           'The wearer gets +1 to cast all arcane spells. In addition, the amulet may be shattered to guarantee the'
    ...
    '46': ['Dazh’s Flint',
           ...
           'ROS2', '204'],
    '47': ['Doomfire Ring',
           'Once per day, by passing a WP roll, the wielder can cast Fireball as if he had Magic. A character with the Lore'
    ...
    '75': ['Tomb-Blade of Arkhan',
           ...
           'ROS1', '164'],
    '76': ['Antlers of the Blue Stag',
           'The community of warriors who owns it get a +10 to all WS and BS checks.',
           'TOS', '249'],
    '77': ['Black Pomander',
           'When worn around the neck, all Undead attacking the wearer get -20 to WS.',
           'TOS', '249'],
    '78': ['The Bountiful Net',
           'The owner will always be able to lift it, though with effort, no matter what'
           ' it contains, whether a single fish or many tons of gold.'
           'TOS', '249'],
    '79': ['Eagle Banner',
           'All allies in sight get +10 to Fear and Terror tests. As a full action, the bearer can'
           ' make a Strategy/Tactics roll to give another character +10 WS for a full round.',
           'TOS', '249'],
    '80': ['Grease of Caccino',
           'Books rubbed with this grease become waterproof and impervious to decay.',
           'TOS', '250'],
    '81': ['The Grieve',
           'A target wounded by this dagger must pass T -10 or take a Critical Hit one step worse than'
           ' would be normal for that wound. If no critical hit is scored, it is still a +1 Critical Hit.',
           'TOS', '250'],
    '82': ['Jade Amulet',
           'The wearer ignores the first point of damage from any hit.',
           'TOS', '250'],
    '83': ["The Pauper's Box",           
           "Any deal overseen by the Pauper's Box eventually fails.",
           'TOS', '251'],
    '84': ["Ranald's Coin",
           'Gives extra Fortune Points, at the expense of others. See manual.',
           'TOS', '251'],
    '85': ['Red Bandages',
           'The bandaged character immediately recovers all lost Wounds. Can only be used once.',
           'TOS', '251'],
    '86': ['White Wolf Cloak',
           'The wearer is immune to all cold effects, whether mundane or magical, including spells and attacks.',
           'TOS', '251']
...
def pick_special():
    ...
    final_object = [name, description, source, page]
    return final_object
