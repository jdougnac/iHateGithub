...
wand_dict = {
    ...
    '3': ['Wand of Corrosion', 'At dawn each day, roll 1d6. That is the amount of times the wand can be '
                               ...
                               'ROS 2, p. 159).', 'AN', '46'],
    '4': ['Wand of Fear', 'A spellcaster may cast Cause Cowardly Flight, Cause Fear and Cause Panic at will.'
          ' If they already know them, no roll is needed. See manual.', 'AN', '46'],
    '5': ['Wand of Jade',
